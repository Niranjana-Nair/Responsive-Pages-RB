                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <h3 class="content-title">Why should we carpool</h3>
                        </div>
                    </div>
                    <div class="row">
                        <p class="mt-4 mb-5">If we could all carpool, it would cut down the number of cars on the road to a great extent; mean there would be less emission of carbon into the air, causing less pollution.; mean a cleaner environment.</p>
                    </div>
                </div>
            </section>
